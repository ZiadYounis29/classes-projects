...
/// Sentinel language code used in batch/playlist "All same" mode to mean
/// "download the auto-caption track in this video's original language."
///
/// Each video may have a different original language (e.g. 'en-orig',
/// 'ar-orig', 'es-orig'). Rather than forcing the user to pick one specific
/// language for the whole batch, this sentinel tells
/// [DownloadQueueController] to resolve the correct *-orig code per-item
/// at download time. Items that have no auto-caption track are skipped.
const String kAutoOrigSentinel = 'auto-orig';
